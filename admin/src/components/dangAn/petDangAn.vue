<template>
	...
	<div>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>病人档案中心</el-breadcrumb-item>
			<el-breadcrumb-item>病人档案</el-breadcrumb-item>
		</el-breadcrumb>
		<el-card>
			...
			<el-row :gutter="20">
				<el-col :span="9">
					<el-input placeholder="请输入病人姓名查找" v-model='queryInfo.query_data' clearable @clear="dangAn_Msg">
			...
			<el-table :data="dangAn_List" border>
				...
				<el-table-column prop="petname" label="病人姓名"></el-table-column>
				<el-table-column prop="photoUrl" label="病人照片">
					<template slot-scope="scope">
						<img style="width: 100px; height: 100px" :src="scope.row.photoUrl" alt="这是图片">
					</template>
				</el-table-column>
				<el-table-column prop="petusername" label="病人家属姓名"></el-table-column>
