	...
	<div id="box">
		...
		<div >
			<van-cell-group inset >
				...
				<van-cell is-link title="我的病人" value="" @click="myBingRen" />
				...
				<van-cell is-link title="修改密码" value="" @click="Alterpasd1" />
				 <!-- <hr>	 -->
				<van-cell is-link title="个人信息" value="" @click="myMsg" /> 
				
				<!-- <van-cell is-link title="结果报告" value="" />
				<van-cell is-link title="收货地址" value="" /> -->
				<!-- <hr> -->
				<van-cell is-link title="设置个人信息" value=""  @click="shezhi1"/>
