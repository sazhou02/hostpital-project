		...
		methods:{
			...
			async getMsg(){
				...
				if(res.status==200){
					...
					this.formMsg[1].value=res.data.address
					this.formMsg[2].value=res.data.petname
					this.formMsg[3].value=res.data.email
					this.formMsg[4].value=res.data.phone
					this.formMsg[5].value=res.data.sex
